...
class Transactions {
        ...
        return {
            getRawAbi(accountName) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const abi = chain_numeric_1.base64ToBinary(rawAbi.abi);
    ...
    sign({ abiMap = Transactions.abiMap, chainId, privateKeys, transaction, serializedTransaction, serializedContextFreeData, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                compression: 0,
                packed_context_free_data: chain_numeric_1.arrayToHex(signedTx.serializedContextFreeData || new Uint8Array(0)),
                packed_trx: chain_numeric_1.arrayToHex(signedTx.serializedTransaction),
    ...
    multicastServers({ endpoint, body, fetchOptions, requestTimeout }) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield utils_1.asyncWaterfall({
