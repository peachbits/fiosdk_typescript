...
export declare class FIOSDK {
    ...
    **/
    static setRawAbiMissingWarnings(rawAbiName: string, fioSdkInctance: FIOSDK): void;
    /**
     ...
     */
    registerFioAddress(fioAddress: string, maxFee: number, technologyProviderId?: string | null, expirationOffset?: number): Promise<RegisterFioAddressResponse>;
    /**
     ...
     * @param expirationOffset Expiration time offset for this transaction in seconds. Default is 180 seconds. Increasing number of seconds gives transaction more lifetime term.
     */
    registerOwnerFioAddress(fioAddress: string, ownerPublicKey: string, maxFee: number, technologyProviderId?: string | null, expirationOffset?: number): Promise<RegisterFioAddressResponse>;
    /**
     ...
     */
    getGrantorPermissions(grantorAccount: string, limit?: number, offset?: number): Promise<PermissionsResponse>;
    /**
     ...
     * @param offset First request from list to return. If omitted, 0 is assumed.
     */
    getObjectPermissions(permissionName: string, objectName: string, limit?: number, offset?: number): Promise<PermissionsResponse>;
    /**
     ...
     * @ignore
     */
    getAccountPubKey(account: string): Promise<any>;
    /**
    * @ignore
    */
    getEncryptKey(fioAddress: string): Promise<any>;
    /**
     * @ignore
     */
